...
export type AccountFilterNoRelations = Omit<
  Account,
  'id' | 'nodeId' | '__typename' | 'opportunitiesByAccountId' | 'usersByAccountId'
>;
...
export const availableFields = Object.keys(fieldMappings).map(field => ({ id: field, label: startCase(field), value: field }));
