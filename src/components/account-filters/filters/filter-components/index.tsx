import { DatePicker, Input, MultiSearchSelector, MultiSearchSelectProps, NumberInput, PropertySelector, PropertySelectorProps } from '../../../ui-components';
import { Option } from '../../../ui-components/selector-box';
...
export const datetimeFilterMap = {
  ...
  isNull: (props: PropertySelectorOptionType) => <PropertySelector {...props} />,
...
export const numberFilterMap = {
  ...
  /** Greater than or equal to the specified value. */
  greaterThanOrEqualTo: (props: InputProps<number>) => <NumberInput {...props} />,
  /** Is null (if `true` is specified) or is not null (if `false` is specified). */
  isNull: (props: PropertySelectorOptionType) => <PropertySelector {...props} />,
  /** Less than the specified value. */
...
export const stringFilterMap = {
  ...
  /** Equal to the specified value. */
  equalTo: (props: PropertySelectorOptionType) => <PropertySelector {...props} />,
  ...
  /** Not equal to the specified value. */
  notEqualTo: (props: PropertySelectorOptionType) => <PropertySelector {...props} />,
