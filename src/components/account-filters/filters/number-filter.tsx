...
import { Option, PropertySelector, renderDropdownOption } from '../../ui-components';
import { booleanValueOptions, numberFilterMap, numberOptions, RenderTypeMap, RenderTypes } from './filter-components';
...
export const NumberFilter = ({ name, value }: SharedFilterInputTypes) => {
  ...
  const handleValueChange = useCallback((item?: number | string | Option | Option[]) => {
