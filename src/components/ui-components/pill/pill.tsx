...
export const PillInner = (
  ...
  return (
    <PillDiv color={color} bgColor={bgColor} ref={ref} className={className} style={{ border }} onClick={onClick}>
      ...
      {isRemovable && (
        ...
        >
          <Icon.X style={{ maxHeight: 14, maxWidth: 14, display: 'flex', marginLeft: 5, marginRight: -5 }} />
        </RemoveIcon>
      )}
    </PillDiv>
  );
