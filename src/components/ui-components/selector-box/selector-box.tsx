import React, { CSSProperties, ForwardedRef, forwardRef, memo, useCallback, useState } from 'react';
...
export type SelectorBoxProps = {
   ...
   */
  onClick?: (event?: React.MouseEvent<HTMLSpanElement, MouseEvent>, props?: OnClickPropsType) => void;
  /**
  ...
  return (
    ...
    >
      <div 
        ...
        onClick={handleClick}
      >
        {isIcon && <IconStyle>{React.cloneElement(icon as React.ReactElement)}</IconStyle>}
        {children && (
          <div
...
export const SelectorBox = memo(forwardRef(SelectorBoxInner)) as typeof SelectorBoxInner;
