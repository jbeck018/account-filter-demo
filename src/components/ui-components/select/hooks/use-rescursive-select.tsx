...
import { Option } from '../../selector-box';
...
export type RecursiveStateItem<T extends Option = Option> = { data: T; options: OnSelectOptions };
...
export function useRecursiveSelect<T extends Option = Option>() {
  ...
  return useMemo(() => {
    ...
    const onSelect = (item: T, options?: OnSelectOptions) => setItems(prev => [...prev, { data: item, options }] as any[]);
